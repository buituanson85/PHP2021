                                        ...
                                        <div class="mega-content">
                                            ...
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        <li class="menu-item" ><a class="menu-name" href="blog-post.php">Blog Single</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="blog-v01.php">Blog Style 01</a></li>
                                                        ...
                                                        <li class="menu-item" ><a class="menu-name" href="about-us.php">About Us</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="checkout.php">Checkout</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="shopping-cart.php">Shopping Cart</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="login.html">Login/Register</a></li>
                                                        <li class="menu-item" ><a class="menu-name" href="404.php">404</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        ...
                                                        <li><a href="category-grid-left-sidebar.php">Grid Left Sidebar</a></li>
                                                        <li><a href="category-grid-right-sidebar.html">Grid Right Sidebar</a></li>
                                                        <li><a href="category-list.html">List Full</a></li>
                                                        <li><a href="category-list-left-sidebar.php">List Left Sidebar</a></li>
                                            ...
                                            <div class="col-lg-3 col-md-3 col-xs-12 md-margin-bottom-0 xs-margin-bottom-25">
                                                <div class="wrap-custom-menu vertical-menu">
                                                    ...
                                                    <ul class="menu">
                                                        ...
                                                        <li><a href="single-product.php">Variable</a></li>
