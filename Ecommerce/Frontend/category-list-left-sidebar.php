                            ...
                            <div class="flt-item to-right">
                                ...
                                <div class="wrap-selectors">
                                    ...
                                    <div class="selector-item viewmode-selector">
                                        <a href="category-grid-left-sidebar.php" class="viewmode grid-mode"><i class="biolife-icon icon-grid"></i></a>
                                        <a href="category-list-left-sidebar.php" class="viewmode detail-mode active"><i class="biolife-icon icon-list"></i></a>
                                    </div>
                                </div>
                            </div>
                        </div>
